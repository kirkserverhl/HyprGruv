...
complete -c 'mkfs.btrfs' -l compress -d 'Try to compress files when using --rootdir'
...
complete -c 'mkfs.btrfs' -s V -l version -d 'Print the mkfs. btrfs version, builtin features and exit'
