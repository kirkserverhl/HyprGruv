...
complete -c ps -s e
complete -c ps -s a -d 'Select all processes except both session leaders (see getsid (2)) and process…'
...
complete -c ps -l signames -d 'Show signal masks using abbreviated signal names and expands the collumn'
