...
complete -c busctl -s C -l capsule -d 'Execute operation on a capsule.  Specify a capsule name to connect to'
complete -c busctl -s l -l full -d 'Do not ellipsize the output in list command. sp Added in version 245'
