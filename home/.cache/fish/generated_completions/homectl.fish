...
complete -c homectl -l offline -d 'Do not attempt to update the copy of the user record and blob directory that …'
...
complete -c homectl -l blob -s b -l blob -s b
complete -c homectl -l avatar -l login-background
...
complete -c homectl -l session-launcher
complete -c homectl -l session-type
