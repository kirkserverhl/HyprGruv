...
complete -c rofi -o icon-theme -o dump-config
complete -c rofi -o show -d 'can be set here'
...
complete -c rofi -o list-keybindings -d 'List all known keybindings without trying to parse them'
complete -c rofi -o threads -d 'Specify the number of threads rofi should use:'
...
complete -c rofi -o kb-toggle-case-sensitivity
...
complete -c rofi -o transient-window -d 'Make rofi react like a modal dialog that is transient to the currently focuse…'
complete -c rofi -o steal-focus -d 'Make rofi steal focus on launch and restore close to window that held it when…'
complete -c rofi -o refilter-timeout-limit -d 'The time (in ms) boundary filter may take before switch from instant to delay…'
...
complete -c rofi -o drun-display-format -d 'The format string for the drun dialog:'
...
complete -c rofi -l sort -d 'Enable, disable sort for filtered menu'
complete -c rofi -o kb-toggle-sort
complete -c rofi -o sorting-method -d 'There are 2 methods:'
...
complete -c rofi -s m -s m -o monitor -o monitor -d 'Select monitor to display rofi on'
complete -c rofi -s 1 -d '[bu] 2'
complete -c rofi -s 2 -d 'will be displayed on top of the focused window).  [bu] 2'
complete -c rofi -s 3 -d 'normal context menu behavior. ) [bu] 2'
complete -c rofi -s 4 -d '[bu] 2'
complete -c rofi -s 5
...
complete -c rofi -o ssh-client -d 'Override the used ssh client.  Pattern: {ssh-client}'
...
complete -c rofi -o parse-known-hosts -d 'Parse the [ti]/. ssh/known_hosts file for entries.  Default: enabled'
...
complete -c rofi -o window-format -d 'Format what is being displayed for windows.  format: {field[:len]}'
...
complete -c rofi -o combi-display-format -d 'The format string for entries in the combi dialog:'
complete -c rofi -o disable-history -d 'Disable or re-enable history'
...
complete -c rofi -o click-to-exit -d 'Click the mouse outside the rofi window to exit.  Default: enabled'
