...
complete -c dir -s f -d 'same as -a -U'
...
complete -c dir -l group-directories-first -d 'group directories before files'
...
complete -c dir -l sort -d 'change default \'name\' sort to WORD: none (-U), size (-S), time (-t), version …'
...
complete -c dir -s U -d 'do not sort directory entries'
