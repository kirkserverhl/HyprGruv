...
complete -c vdir -s f -d 'same as -a -U'
...
complete -c vdir -l group-directories-first -d 'group directories before files'
...
complete -c vdir -l sort -d 'change default \'name\' sort to WORD: none (-U), size (-S), time (-t), version …'
...
complete -c vdir -s U -d 'do not sort directory entries'
