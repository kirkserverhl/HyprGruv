...
--                      Ctrl+Alt+Del
--                      Zoom is compositor-only (Meridian): Super + scroll / +/- / Shift+0.
--                      Bare Ctrl+scroll / Ctrl+/- stay with apps (Chrome page zoom).
...
-- Alt+scroll: occupied workspace cycle. Super+scroll is compositor zoom (see #zoom).
-- Ctrl+scroll is not bound — apps (Chrome) keep native page zoom.
...
-- Super +/- is compositor zoom (Meridian). Workspace cycle: Super+Tab / Super+N / Alt+scroll.
...
-- Zoom (Meridian baseline — compositor magnifier only).
-- Docs: Documents/hyprcourse/meridian/README.md
--   Super + Mouse Wheel  zoom in/out
--   Super + =            zoom in
--   Super + -            zoom out
--   Super + Shift + 0    reset zoom   (workspace 10 unused)
-- App zoom is native: Chrome Ctrl+scroll / Ctrl+/- is no longer intercepted.
-- plus is bound with equal because Shift+= is a different keysym.
--
...
hl.bind(mainMod .. " + mouse_up", zoom_in) -- #zoom Super+scroll zoom in
hl.bind(mainMod .. " + mouse_down", zoom_out) -- #zoom Super+scroll zoom out
hl.bind(mainMod .. " + equal", zoom_in, { repeating = true }) -- #zoom Super+= zoom in
hl.bind(mainMod .. " + plus", zoom_in, { repeating = true }) -- #zoom Super++ zoom in (Shift+=)
hl.bind(mainMod .. " + minus", zoom_out, { repeating = true }) -- #zoom Super+- zoom out
hl.bind(mainMod .. " + SHIFT + 0", zoom_rst) -- #zoom Super+Shift+0 reset zoom

-- ── hashed out: Mac-mirror zoom (app inject + Ctrl monitor) ────────────────
-- Super ≈ Cmd injected Ctrl+/- into the focused app; Ctrl+scroll magnified
-- the monitor. Chrome Ctrl+scroll / Ctrl+/- then overlapped compositor zoom.
-- Keep this block as the previous experiment while Meridian is the baseline.
--
...
-- end
-- local function app_zoom_in() send_app("CTRL", "equal") end
-- local function app_zoom_out() send_app("CTRL", "minus") end
...
-- 	send_app("CTRL", "0")
-- end
-- hl.bind(mainMod .. " + mouse_up", app_zoom_in) -- Super+scroll app zoom in
-- hl.bind(mainMod .. " + mouse_down", app_zoom_out)
-- hl.bind(mainMod .. " + SHIFT + mouse_up", app_zoom_in)
-- hl.bind(mainMod .. " + SHIFT + mouse_down", app_zoom_out)
-- hl.bind(mainMod .. " + equal", app_zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + plus", app_zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + SHIFT + equal", app_zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + minus", app_zoom_out, { repeating = true })
-- hl.bind(mainMod .. " + KP_Add", app_zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + KP_Subtract", app_zoom_out, { repeating = true })
-- hl.bind(mainMod .. " + 0", app_zoom_rst)
-- hl.bind(mainMod .. " + backspace", app_zoom_rst)
...
-- hl.bind("CTRL + mouse_up", zoom_in)
-- hl.bind("CTRL + mouse_down", zoom_out)
-- hl.bind("CTRL + SHIFT + mouse_up", zoom_in)
-- hl.bind("CTRL + SHIFT + mouse_down", zoom_out)
-- hl.bind("CTRL + equal", zoom_in, { repeating = true })
-- hl.bind("CTRL + plus", zoom_in, { repeating = true })
-- hl.bind("CTRL + SHIFT + equal", zoom_in, { repeating = true })
-- hl.bind("CTRL + minus", zoom_out, { repeating = true })
-- hl.bind("CTRL + KP_Add", zoom_in, { repeating = true })
-- hl.bind("CTRL + KP_Subtract", zoom_out, { repeating = true })
-- hl.bind("CTRL + backspace", zoom_rst)
-- hl.bind(mainMod .. " + " .. altMod .. " + equal", zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + " .. altMod .. " + plus", zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + " .. altMod .. " + SHIFT + equal", zoom_in, { repeating = true })
-- hl.bind(mainMod .. " + " .. altMod .. " + minus", zoom_out, { repeating = true })
-- hl.bind(mainMod .. " + " .. altMod .. " + backspace", zoom_rst)
