...
-- Launchers: Super+Space = all apps (favorites/common-apps menu removed)
...
hl.bind(mod     .. " + D", hl.dsp.exec_cmd(SCRIPTS .. "/notifications.sh menu"))
hl.bind(mod .. " + CTRL + SHIFT + A", hl.dsp.exec_cmd(SCRIPTS .. "/notifications.sh close-all"))
