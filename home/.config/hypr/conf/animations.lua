...
-- Toggle via settings/animations_enabled.sh (apply-machine-profile / settings UI).

local settings = require("conf.settings")
local anim_on = settings.read_bool("animations_enabled", true)

hl.config({ animations = { enabled = anim_on } })
