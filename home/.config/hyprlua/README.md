...
- Most of the `scripts/` directory — they are referenced by absolute path from the original `~/.config/hyprgruv/scripts`. This keeps things working without duplication.
