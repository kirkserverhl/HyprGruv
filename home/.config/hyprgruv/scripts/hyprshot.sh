...
# Screenshot Filename
source ~/.config/hyprgruv/scripts/screenshot-filename.sh

# Screenshot Folder
source ~/.config/hyprgruv/scripts/screenshot-folder.sh

# Screenshot Editor — uses ~/.config/settings/editor.sh
export EDITOR="$("$HOME/.config/hyprgruv/scripts/editor.sh" --print)"
