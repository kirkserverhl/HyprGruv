#!/bin/bash
# ===================================================================
# DEPRECATED / LEGACY WALLPAPER SCRIPT
# ===================================================================
# This is the old wallpaper.sh from previous Hyprland builds.
# It is kept for reference only.
#
# DO NOT use this as your main wallpaper handler anymore.
# The active script is now:
#     ~/.config/hyprgruv/scripts/set_wallpaper.sh
#
# That script has merged the useful parts (blur generation, square,
# rasi, effects, caching) while using modern matugen + Waypaper.
#
