...
SEMANTIC_MAP = {
    ...
    "surface_container_high": "base01",
    "surface_container_highest": "base03",
    "outline_variant": "base03",
    "outline": "base04",
    "on_surface_variant": "base04",
    "on_surface": "base05",
    "inverse_on_surface": "base06",
    "inverse_surface": "base05",
    ...
    "on_error": "base00",
    "on_error_container": "base05",
    "tertiary": "base09",
    "on_tertiary": "base00",
    "on_tertiary_container": "base05",
    "secondary": "base0a",
    "on_secondary": "base00",
    "on_secondary_container": "base05",
    # Super+W source/primary lives in base0d (roles.json active_border).
    "primary": "base0d",
    "primary_container": "base0c",
    "primary_fixed": "base0d",
    "on_primary": "base00",
    "on_primary_container": "base00",
