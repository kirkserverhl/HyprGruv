...
export SCRIPT_DIR CONFIG_DIR BACKUP_DIR
{
	...
	PACKAGES1=(
		bluez bluez-utils btop cmake cpio duf eza fastfetch fzf ghostty grimblast-git gsettings-qt hyprgraphics
		hypridle hyprland-qt-support hexyl hyprpaper hyprpicker hyprshade mediainfo iwgtk meson neovim neovim-cmp neovim-lspconfig network-manager-applet
		...
		pavucontrol pkg-config python-pywalfox qt5-graphicaleffects qt6ct-kde rofi-calc tig tmux tree-sitter wl-clipboard
